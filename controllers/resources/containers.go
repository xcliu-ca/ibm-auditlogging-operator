...
// HB re-evaluate resources for policy controller hardcoded
...
var fluentdMainContainer = corev1.Container{
	Image:           constant.DefaultImageRegistry + constant.DefaultFluentdImageName + ":" + constant.DefaultFluentdImageTag,
	Name:            constant.FluentdName,
...
var policyControllerMainContainer = corev1.Container{
	Image:           constant.DefaultImageRegistry + constant.DefaultPCImageName + ":" + constant.DefaultPCImageTag,
	Name:            constant.AuditPolicyControllerDeploy,
	ImagePullPolicy: corev1.PullIfNotPresent,
